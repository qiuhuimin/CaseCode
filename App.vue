...
<style >
	...
	@font-face {font-family: "iconfont";
	  src: url('~@/static/icon/iconfont.eot?t=1576844226174'); /* IE9 */
	  src: url('~@/static/icon/iconfont.eot?t=1576844226174#iefix') format('embedded-opentype'), /* IE6-IE8 */
	  ...
	  url('~@/static/icon/iconfont.woff?t=1576844226174') format('woff'),
	  url('~@/static/icon/iconfont.ttf?t=1576844226174') format('truetype'), /* chrome, firefox, opera, Safari, Android, iOS 4.2+ */
	  url('~@/static/icon/iconfont.svg?t=1576844226174#iconfont') format('svg'); /* iOS 4.1- */
	}
